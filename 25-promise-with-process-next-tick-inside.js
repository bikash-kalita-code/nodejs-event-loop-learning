...
Promise.resolve().then(() => {
    console.log('Before process.nextTick 2')
    process.nextTick(processNextTickCallback2)
});
Promise.resolve().then(() => {
    console.log('Before process.nextTick 3')
    process.nextTick(processNextTickCallback3)
});
